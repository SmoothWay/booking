...
func (r *userRepository) GetUsers(ctx context.Context, page int, pageSize int) ([]*domain.User, error) {
	query := `SELECT id, name, email, phone, password, role, created_at, updated_at, deleted_at FROM users LIMIT $1 OFFSET $2`
...
func (r *userRepository) GetUserByID(ctx context.Context, id string) (*domain.User, error) {
	query := `SELECT id, name, email, phone, password, role, created_at, updated_at, deleted_at FROM users WHERE id = $1`
	var user domain.User
...
func (r *userRepository) CreateUser(ctx context.Context, user *domain.User) error {
	query := `INSERT INTO users (id, name, email, phone, password, role, created_at, updated_at, deleted_at) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9)`
...
func (r *userRepository) UpdateUser(ctx context.Context, user *domain.User) error {
	query := `UPDATE users SET name = $1, email = $2, phone = $3, password = $4, role = $5, updated_at = $6, deleted_at = $7 WHERE id = $8`
